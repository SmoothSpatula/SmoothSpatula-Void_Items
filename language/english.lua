return {
    item = {
        voidsentFlame = {
            ...
            description = "Upon hitting an enemy at <y>full health</c>, spawn a <y>lava pillar</c> in a <y>12m</c> </g>(+2.4m per stack)</c> radius for <y>260%</c> <g>(+156% per stack)</c> base damage. <p>Corrupts all Will-o'-the-wisps.</c>",
        },

        weepingFungus = {
            name        = "Weeping Fungus",
            pickup      = "Heal while sprinting. <p>Corrupts all Bustling Fungi.</c>",
        ...
        polylute = {
            ...
            description = "<y>25%</c> chance to fire <y>lightning</c> for <y>60%</c> TOTAL damage up to <y>3</c> <c_stack>(+3 per stack)</c> times. <p>Corrupts all Ukuleles.</c>",
        },
        ...
        plasmaShrimp = {
            ...
            description = "Gain a <g>shield</c> equal to <g>10%</c> of your maximum health. While you have a <g>shield</c>, hitting an enemy fires a missile that deals <y>40%</c> <c_stack>(+40% per stack)</c> TOTAL damage. <p>Corrupts all AtG Missile Mk. 1s.</c>",
        },

        lysateCell = {
            name        = "Lysate Cell",
            pickup      = "Add an extra charge of your Special skill. <p>Corrupts all Fuel Cells.</c>",
            description = "Add <b>+1</c> <c_stack>(+1 per stack)</c> charge of your <b>Special skill</c>. <b>Reduces Special skill cooldown</c> by <b>33%</c>. <p>Corrupts all Fuel Cells.</c>",
        },

        pluripotentLarva = {
            name        = "Pluripotent Larva",
            pickup      = "Get a <p>corrupted</c> extra life. Consumed on use. <p>Corrupts all Dio's Best Friends.</c>",
            description = "<b>Upon death</c>, this item will be <b>consumed</c> and you will <g>return to life</c> with <g>3 seconds of invulnerability</c>, and all of your items that can be <b>corrupted</c> will be. <p>Corrupts all Dio's Best Friends.</c>",
        },
        ...
        benthicBloom = {
            ...
            description = "<b>Upgrades 3</c> <c_stack>(+3 per stack)</c> random items to items of the next <b>higher rarity</c> at the <b>start of each stage</c>. <p>Corrupts all 57 Leaf Clovers.</c>",
        },
    }
}