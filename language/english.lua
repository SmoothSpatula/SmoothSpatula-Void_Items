return {
    item = {
        voidsentFlame = {
            ...
            description = "Upon hitting an enemy at <y>full health</c>, spawn a <y>lava pillar</c> in a <y>12m</c> <c_stack>(+2.4m per stack)</c> radius for <y>150%</c> <c_stack>(+80% per stack) <y>damage</c>. <p>Corrupts all Will-o'-the-wisps.</c>",
            destination = "",
            date        = "",
        ...
        polylute = {
            ...
            description = "<y>20%</c> chance to fire <y>lightning</c> for <y>3x50% <c_stack>(+50% per stack) <y>TOTAL damage</c>. <p>Corrupts all Ukuleles.</c>",
            destination = "",
            date        = "",
